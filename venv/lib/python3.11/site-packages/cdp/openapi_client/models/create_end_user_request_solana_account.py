...
class CreateEndUserRequestSolanaAccount(BaseModel):
    """
    Configuration for creating a Solana account for the end user.
    """ # noqa: E501
    create_smart_account: Optional[StrictBool] = Field(default=False, description="Only false is a valid option since currently smart accounts on Solana are not supported.", alias="createSmartAccount")
