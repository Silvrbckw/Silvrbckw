...
class SendEndUserEvmTransactionRule(BaseModel):
    ...
    criteria: List[SendEvmTransactionCriteriaInner] = Field(description="A schema for specifying criteria for the sendEndUserEvmTransaction operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['sendEndUserEvmTransaction']):
            raise ValueError("must be one of enum values ('sendEndUserEvmTransaction')")
        return value
