...
class ListSolanaTokenBalances200Response(BaseModel):
    """
    ...
    balances: List[SolanaTokenBalance] = Field(description="The list of Solana token balances.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balances": [SolanaTokenBalance.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
