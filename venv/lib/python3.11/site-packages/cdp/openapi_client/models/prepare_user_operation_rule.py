...
class PrepareUserOperationRule(BaseModel):
    ...
    criteria: List[SendEvmTransactionCriteriaInner] = Field(description="A schema for specifying criteria for the PrepareUserOperation operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['prepareUserOperation']):
            raise ValueError("must be one of enum values ('prepareUserOperation')")
        return value
