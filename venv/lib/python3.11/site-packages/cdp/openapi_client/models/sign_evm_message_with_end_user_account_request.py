...
class SignEvmMessageWithEndUserAccountRequest(BaseModel):
    """
    ...
    message: StrictStr = Field(description="The message to sign.")
    ...
    __properties: ClassVar[List[str]] = ["address", "message", "walletSecretId"]
