...
class CreateSwapQuoteResponseAllOfPermit2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["hash", "eip712"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of eip712
        if self.eip712:
            _dict['eip712'] = self.eip712.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hash": obj.get("hash"),
            "eip712": EIP712Message.from_dict(obj["eip712"]) if obj.get("eip712") is not None else None
        })
        return _obj
