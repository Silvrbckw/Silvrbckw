...
class SignEvmMessageRule(BaseModel):
    ...
    criteria: List[SignEvmMessageCriteriaInner] = Field(description="A schema for specifying the rejection criteria for the SignEvmMessage operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['signEvmMessage']):
            raise ValueError("must be one of enum values ('signEvmMessage')")
        return value
