...
class SignEndUserEvmTypedDataRule(BaseModel):
    ...
    criteria: List[SignEvmTypedDataCriteriaInner] = Field(description="A schema for specifying criteria for the signEndUserEvmTypedData operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['signEndUserEvmTypedData']):
            raise ValueError("must be one of enum values ('signEndUserEvmTypedData')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": [SignEvmTypedDataCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
