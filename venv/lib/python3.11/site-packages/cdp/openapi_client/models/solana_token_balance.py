...
class SolanaTokenBalance(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "amount": SolanaTokenAmount.from_dict(obj["amount"]) if obj.get("amount") is not None else None,
            "token": SolanaToken.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj
