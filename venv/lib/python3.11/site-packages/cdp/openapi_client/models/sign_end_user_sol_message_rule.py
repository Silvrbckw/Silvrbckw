...
class SignEndUserSolMessageRule(BaseModel):
    ...
    criteria: List[SignSolMessageCriteriaInner] = Field(description="A schema for specifying criteria for the signEndUserSolMessage operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['signEndUserSolMessage']):
            raise ValueError("must be one of enum values ('signEndUserSolMessage')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "criteria": [SignSolMessageCriteriaInner.from_dict(_item) for _item in obj["criteria"]] if obj.get("criteria") is not None else None
        })
        return _obj
