...
class CreateDelegationForEndUserAccountRequest(BaseModel):
    """
    CreateDelegationForEndUserAccountRequest
    """ # noqa: E501
    expires_at: datetime = Field(description="The date until which the delegation is valid.", alias="expiresAt")
    ...
    __properties: ClassVar[List[str]] = ["expiresAt", "walletSecretId"]
