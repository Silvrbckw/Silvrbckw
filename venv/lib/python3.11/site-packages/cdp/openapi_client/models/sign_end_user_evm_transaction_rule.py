...
class SignEndUserEvmTransactionRule(BaseModel):
    ...
    criteria: List[SignEvmTransactionCriteriaInner] = Field(description="A schema for specifying criteria for the signEndUserEvmTransaction operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['signEndUserEvmTransaction']):
            raise ValueError("must be one of enum values ('signEndUserEvmTransaction')")
        return value
