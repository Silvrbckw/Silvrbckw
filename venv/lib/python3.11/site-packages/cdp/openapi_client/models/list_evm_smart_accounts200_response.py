...
class ListEvmSmartAccounts200Response(BaseModel):
    """
    ...
    accounts: List[EvmSmartAccount] = Field(description="The list of Smart Accounts.")
    __properties: ClassVar[List[str]] = ["nextPageToken", "accounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accounts": [EvmSmartAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
