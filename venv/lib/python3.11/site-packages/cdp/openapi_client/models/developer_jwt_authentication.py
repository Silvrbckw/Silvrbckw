...
class DeveloperJWTAuthentication(BaseModel):
    """
    ...
    kid: StrictStr = Field(description="The key ID of the JWK used to sign the JWT.")
    sub: StrictStr = Field(description="The unique identifier for the end user that is captured in the `sub` claim of the JWT.")
    __properties: ClassVar[List[str]] = ["type", "kid", "sub"]
