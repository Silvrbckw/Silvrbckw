...
class ListEvmAccounts200Response(BaseModel):
    """
    ...
    accounts: List[EvmAccount] = Field(description="The list of EVM accounts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accounts": [EvmAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
