...
class CommonSwapResponseIssuesAllowance(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["currentAllowance", "spender"]

    @field_validator('current_allowance')
    def current_allowance_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currentAllowance": obj.get("currentAllowance"),
