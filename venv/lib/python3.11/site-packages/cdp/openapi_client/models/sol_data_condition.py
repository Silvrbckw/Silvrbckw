...
class SolDataCondition(BaseModel):
    ...
    """ # noqa: E501
    instruction: StrictStr = Field(description="The instruction name.")
    params: Optional[List[SolDataConditionParamsInner]] = Field(default=None, description="Parameter conditions for the instruction.")
    __properties: ClassVar[List[str]] = ["instruction", "params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": [SolDataConditionParamsInner.from_dict(_item) for _item in obj["params"]] if obj.get("params") is not None else None
        })
        return _obj
