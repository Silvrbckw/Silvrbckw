...
class ListSolanaAccounts200Response(BaseModel):
    """
    ...
    accounts: List[SolanaAccount] = Field(description="The list of Solana accounts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accounts": [SolanaAccount.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None
        })
        return _obj
