...
class WebhookSubscriptionListResponse(BaseModel):
    ...
    subscriptions: List[WebhookSubscriptionResponse] = Field(description="The list of webhook subscriptions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subscriptions": [WebhookSubscriptionResponse.from_dict(_item) for _item in obj["subscriptions"]] if obj.get("subscriptions") is not None else None
        })
        return _obj
