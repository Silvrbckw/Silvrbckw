...
class SignEndUserSolTransactionRule(BaseModel):
    ...
    criteria: List[SignSolTransactionCriteriaInner] = Field(description="A schema for specifying criteria for the signEndUserSolTransaction operation.")
    ...
    def operation_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['signEndUserSolTransaction']):
            raise ValueError("must be one of enum values ('signEndUserSolTransaction')")
        return value
