...
class TestSendEndUserSolAssetCriteriaInner(unittest.TestCase):
    """SendEndUserSolAssetCriteriaInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEndUserSolAssetCriteriaInner:
        """Test SendEndUserSolAssetCriteriaInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEndUserSolAssetCriteriaInner`
        """
        model = SendEndUserSolAssetCriteriaInner()
        if include_optional:
            return SendEndUserSolAssetCriteriaInner(
                type = 'splAddress',
    ...
    def testSendEndUserSolAssetCriteriaInner(self):
        """Test SendEndUserSolAssetCriteriaInner"""
