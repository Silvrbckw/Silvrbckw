...
class TestSendEndUserEvmAssetRule(unittest.TestCase):
    """SendEndUserEvmAssetRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEndUserEvmAssetRule:
        """Test SendEndUserEvmAssetRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEndUserEvmAssetRule`
        """
        model = SendEndUserEvmAssetRule()
        if include_optional:
            return SendEndUserEvmAssetRule(
                action = 'accept',
    ...
    def testSendEndUserEvmAssetRule(self):
        """Test SendEndUserEvmAssetRule"""
