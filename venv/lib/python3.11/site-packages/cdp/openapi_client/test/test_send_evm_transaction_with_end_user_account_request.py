...
class TestSendEvmTransactionWithEndUserAccountRequest(unittest.TestCase):
    """SendEvmTransactionWithEndUserAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEvmTransactionWithEndUserAccountRequest:
        ...
        # uncomment below to create an instance of `SendEvmTransactionWithEndUserAccountRequest`
        """
        model = SendEvmTransactionWithEndUserAccountRequest()
        if include_optional:
            return SendEvmTransactionWithEndUserAccountRequest(
    ...
    def testSendEvmTransactionWithEndUserAccountRequest(self):
        """Test SendEvmTransactionWithEndUserAccountRequest"""
