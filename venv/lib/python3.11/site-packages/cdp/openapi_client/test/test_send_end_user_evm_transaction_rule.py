...
class TestSendEndUserEvmTransactionRule(unittest.TestCase):
    """SendEndUserEvmTransactionRule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendEndUserEvmTransactionRule:
        """Test SendEndUserEvmTransactionRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEndUserEvmTransactionRule`
        """
        model = SendEndUserEvmTransactionRule()
        if include_optional:
            return SendEndUserEvmTransactionRule(
                action = 'accept',
    ...
    def testSendEndUserEvmTransactionRule(self):
        """Test SendEndUserEvmTransactionRule"""
