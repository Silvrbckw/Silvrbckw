...
class TestSendEvmTransactionRule(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendEvmTransactionRule:
        """Test SendEvmTransactionRule
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEvmTransactionRule`
        """
        model = SendEvmTransactionRule()
        if include_optional:
    ...
    def testSendEvmTransactionRule(self):
        """Test SendEvmTransactionRule"""
