...
class TestCreateSwapQuoteResponseWrapper(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateSwapQuoteResponseWrapper:
        """Test CreateSwapQuoteResponseWrapper
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateSwapQuoteResponseWrapper`
        """
        model = CreateSwapQuoteResponseWrapper()
        if include_optional:
    ...
    def testCreateSwapQuoteResponseWrapper(self):
        """Test CreateSwapQuoteResponseWrapper"""
