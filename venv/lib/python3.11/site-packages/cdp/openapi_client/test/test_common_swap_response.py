...
class TestCommonSwapResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CommonSwapResponse:
        """Test CommonSwapResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommonSwapResponse`
        """
        model = CommonSwapResponse()
        if include_optional:
            return CommonSwapResponse(
    ...
    def testCommonSwapResponse(self):
        """Test CommonSwapResponse"""
