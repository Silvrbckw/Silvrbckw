...
class TestEvmDataCondition(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EvmDataCondition:
        """Test EvmDataCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EvmDataCondition`
        """
        model = EvmDataCondition()
        if include_optional:
