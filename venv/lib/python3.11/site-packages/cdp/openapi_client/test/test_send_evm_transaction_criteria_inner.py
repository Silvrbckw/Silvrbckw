...
class TestSendEvmTransactionCriteriaInner(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SendEvmTransactionCriteriaInner:
        """Test SendEvmTransactionCriteriaInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendEvmTransactionCriteriaInner`
        """
        model = SendEvmTransactionCriteriaInner()
        if include_optional:
    ...
    def testSendEvmTransactionCriteriaInner(self):
        """Test SendEvmTransactionCriteriaInner"""
