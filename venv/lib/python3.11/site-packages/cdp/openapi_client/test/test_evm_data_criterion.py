...
class TestEvmDataCriterion(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EvmDataCriterion:
        """Test EvmDataCriterion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EvmDataCriterion`
        """
        model = EvmDataCriterion()
        if include_optional:
